...
const Header = () => {
    ...
    return (
        <motion.header
            layout
            className={cn(
                'bg-slate-700/50 backdrop-blur-3xl px-6 py-2.5 fixed left-1/2 -translate-x-1/2 text-nowrap flex items-center justify-between gap-24 z-40 overflow-hidden',
            ...
            animate={{
                ...
                borderRadius: isScrolled ? '0.75rem' : '9999px',
            }}
            transition={{
                type: 'spring',
                stiffness: 400,
