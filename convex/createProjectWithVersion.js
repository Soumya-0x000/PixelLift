...
/**
 * Creates a new project with versioning support (v0)
 * This mutation creates:
 * 1. An image record (v0, original)
 * 2. A project record with version pointers
 * 3. A version history entry
 * 4. Updates user storage and project count
 */
